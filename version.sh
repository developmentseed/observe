...
# Use this script to create a new release version.
# To create a new incremental/alpha/beta build, use ./build-version.sh
# This script probably shouldn't be called directly.
# Instead, this script is executed when running `npm version {version}`
